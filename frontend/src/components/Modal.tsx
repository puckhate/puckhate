        ...
        {isOpen && (
          ...
          >
            ...
            <div className="fixed inset-0 flex flex-col items-center justify-center p-6">
              <div className={cn("flex w-full flex-col", WIDTHS[width])}>
                {!hideCloseButton && (
                  <motion.button
                    type="button"
                    onClick={handleClose}
                    ...
                    className="text-body hover:text-heading-pink focus:ring-sky-aqua-500 mb-2 inline-flex size-10 items-center justify-center self-end rounded-xl transition-colors hover:bg-white/10 focus:bg-white/10 focus:ring-2 focus:outline-none"
                  >
                ...
                >
                  {title && (
                    <DialogTitle
                      as="h2"
                      className="font-heading text-body mb-3 text-xl font-bold tracking-tight"
                    >
                      {title}
                    </DialogTitle>
                  )}
