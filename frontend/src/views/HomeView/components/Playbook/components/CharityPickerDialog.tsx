...
interface CharityPickerDialogProps {
  charities: Charity[];
}
...
/**
 * The charity picker dialogue, mounted already open
 */
export default function CharityPickerDialog({
  charities,
}: CharityPickerDialogProps): React.ReactNode {
  return (
    <Modal isOpen label="Get a random charity suggestion" width="large">
      {({ closeModal }) => (
